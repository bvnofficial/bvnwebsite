...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Client build workspace for Hypersonic Wholesale (Riverside Pet & 90 Day Amazon Freedom). The phased automation roadmap, day-one kickoff, live build checklist, and feasibility verdicts — managed by BVN.",
