      ...
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "40px 22px 100px" }}>
        ...
        <Section eyebrow="Proof" title="Multi stage chasing, already built" sub="You asked for an automation with conditional chasing. Here is that exact pattern running in a live GoHighLevel account I built, from the pipelines down to the branch that chases only when it needs to.">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14 }}>
            ...
            <ProofShot src="/proof/regal-01-workflow-library.png" caption="The workflow library, organized into Family and Professional folders, with an intake form router and a booking to pipeline automation feeding the whole system." />
