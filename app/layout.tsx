    ...
    <html lang="en" className="scroll-smooth" suppressHydrationWarning>
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try{var p=location.pathname;if(/^\\/apps\\/.+/.test(p))document.documentElement.classList.add('hide-navbar');if(p==='/command'||/^\\/roblox\\//.test(p)||/^\\/clients\\/(tintgard\\/dashboard|progardfilms|raetzer)/.test(p))document.documentElement.classList.add('hide-navbar','bare-page');}catch(e){}",
          }}
        />
