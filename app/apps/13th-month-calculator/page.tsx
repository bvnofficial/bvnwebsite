    ...
    <div className="min-h-screen bg-navy-dark flex flex-col">
      <div className="flex items-center justify-between px-6 md:px-12 py-4 border-b border-white/10 bg-navy-dark/80 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-white/80 text-sm font-accent font-semibold">13th Month Pay Calculator</span>
        </div>
        <div className="w-24" />
      </div>
      <iframe src="/13th-month-calculator.html" className="flex-1 w-full border-0" style={{ minHeight: "calc(100vh - 57px)" }} title="13th Month Pay Calculator Philippines" />
    </div>
  );
}
