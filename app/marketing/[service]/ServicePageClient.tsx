...
// Lazy-load demos
const SocialMediaDemo = dynamic(() => import("@/components/demos/SocialMediaDemo"));
...
function renderDemo(demoType: string, title: string) {
  switch (demoType) {
    case "social-media": return <SocialMediaDemo />;
...
export default function ServicePageClient({ service }: { service: MarketingService }) {
  return (
    <>
      {/* ── Hero ─────────────────────────────────────────── */}
      <section className="relative min-h-[60vh] flex items-end bg-navy-dark overflow-hidden pt-24 pb-20">
        ...
        <div
          ...
          style={{
            width: "800px",
            height: "400px",
            background: "radial-gradient(ellipse, rgba(232,96,16,0.1) 0%, transparent 70%)",
          }}
        />
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 lg:px-24 w-full">
          <Link href="/marketing" className="inline-flex items-center gap-2 text-white/40 text-sm hover:text-orange transition-colors mb-8">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto">
          <SectionHeader
            ...
            subtitle="Every service is delivered by specialist teams with proven processes and measurable outcomes."
          />
          <motion.div
            variants={stagger}
            initial="hidden"
          ...
          >
            {service.features.map((f) => (
              <motion.div
                ...
                whileHover={{ y: -4, boxShadow: "0 0 24px rgba(232,96,16,0.15)" }}
                className="bg-white/5 border border-white/10 rounded-2xl p-5 hover:border-orange/30 transition-all"
              >
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-orange/15 flex items-center justify-center shrink-0 mt-0.5">
      ...
      >
        <div className="max-w-5xl mx-auto">
          <SectionHeader
            ...
            subtitle="See how our tools and processes work — interact with a live sample below."
            centered
          />
      ...
      >
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-white/60 text-lg mb-8">
            Book a free consultation and we&apos;ll build a custom strategy for your business.
          </p>
